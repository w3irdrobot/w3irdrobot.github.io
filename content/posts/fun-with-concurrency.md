...
First we need to create the context in our `main` function. It's important we create one _and_ get a cancel function for it so we can cancel it later in our program.
